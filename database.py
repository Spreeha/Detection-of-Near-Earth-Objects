...
class NEODatabase:
    ...
    def query(self, filters=()):
        ...
        if filters:
            # Iterate through each approach in the list of approaches
            for approach in self._approaches:
                # Create a list of boolean values indicating whether the approach passes each filter
                filter_results = []
                
                # Iterate through each filter function in the list of filters
                for filter_func in filters:
                    # Apply the current filter function to the current approach
                    passes_filter = filter_func(approach)
                    
                    # Add the result (True or False) to the filter_results list
